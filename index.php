                    ...
                    <div class="row justify-content-center justify-content-sm-center justify-content-md-start">
                        <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                            <div class="single-system">
                                <div class="part-icon">
                                    <img src="frontend/img/svg/add-user.svg" alt="">
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                            <div class="single-system">
                                <div class="part-icon">
                                    <img src="frontend/img/svg/coin.svg" alt="">
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                            <div class="single-system">
                                <div class="part-icon">
                                    <img src="frontend/img/svg/money-bag.svg" alt="">
                                </div>
                                <div class="part-text">
                        ...
                        <div class="part-feature">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                                    <div class="single-feature">
                                        <div class="feature-icon">
                                            <img src="frontend/img/svg/solar-energy.svg" alt="">
                                        </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                                    <div class="single-feature">
                                        <div class="feature-icon">
                                            <img src="frontend/img/svg/diploma.svg" alt="">
                                        </div>
                                        <div class="feature-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                                    <div class="single-feature">
                                        <div class="feature-icon">
                                            <img src="frontend/img/svg/blockchain.svg" alt="">
                                        </div>
                                        <div class="feature-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                                    <div class="single-feature">
                                        <div class="feature-icon">
                                            <img src="frontend/img/svg/worldwide.svg" alt="">
                                        </div>
                                        <div class="feature-text">
                                            <h3>We're Global</h3>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration </p>
                    ...
                    <div class="row no-gutters justify-content-center">
                        <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                            <div class="single-statics">
                                <div class="part-img">
                                    <img src="frontend/img/svg/investor.svg" alt="investor">
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                            <div class="single-statics">
                                <div class="part-img">
                                    <img src="frontend/img/svg/withdraw.svg" alt="investor">
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                            <div class="single-statics">
                                <div class="part-img">
                                    <img src="frontend/img/svg/money-transfering.svg" alt="investor">
                                </div>
                                <div class="part-text">
                ...
                <div class="row justify-content-center justify-content-md-start">
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
                        <div class="single-plan">
                            <h3>Basic Plan</h3>
                            <div class="plan-icon">
                                <img src="frontend/img/icon/bronze-medal.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
                        <div class="single-plan active">
                            <h3>Standard Plan</h3>
                            <div class="plan-icon">
                                <img src="frontend/img/icon/trophy-1.png" alt="">
                            </div>
                            <div class="feature-list">
                                <ul>
                                    <li><i class="fas fa-check"></i> Minimum Deposit $10</li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
                        <div class="single-plan">
                            <h3>Premium Plan</h3>
                            <div class="plan-icon">
                                <img src="frontend/img/icon/trophy.png" alt="">
                            </div>
                            <div class="feature-list">
                                <ul>
                                    <li><i class="fas fa-check"></i> Minimum Deposit $10</li>
                    ...
                    <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
                        ...
                        <div class="col-xl-4 col-lg-4 d-xl-flex d-lg-flex justify-content-end d-block align-items-center">
                            <div class="part-video">
                                <img src="frontend/img/video.jpg" alt="">
                        ...
                        <div class="single-member">
                            <div class="img-box">
                                <div class="part-img">
                                    ...
                                    <img src="frontend/img/member-1.jpg" alt="">
                                </div>
                            </div>
                            <div class="part-text">
                                ...
                                <div class="paid-from">
                                    ...
                                    <span class="paymethod-logo">
                                        <img src="frontend/img/bitcoin.png" alt="">
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-member">
                            <div class="img-box">
                                <div class="part-img">
                                    ...
                                    <img src="frontend/img/member-2.jpg" alt="">
                                </div>
                            </div>
                            <div class="part-text">
                                ...
                                <div class="paid-from">
                                    Paid from :
                                    <span class="paymethod-logo">
                                        <img src=frontend/img/litecoincoin.png" alt="">
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-member">
                            <div class="img-box">
                                <div class="part-img">
                                    ...
                                    <img src="frontend/img/member-3.jpg" alt="">
                                </div>
                            </div>
                            <div class="part-text">
                        ...
                        <div class="transaction-list">
                            <div class="Vertical-Slider">
                                <div class="single-transaction">
                                    <div class="flag">
                                        <img src="frontend/img/flag/flag-2.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                                    ...
                                    <div class="coin">
                                        <img src="frontend/img/svg/bitcoin.svg" alt="">
                                    </div>
                                </div>
                                <div class="single-transaction">
                                    <div class="flag">
                                    ...
                                    <div class="coin">
                                        <img src="frontend/img/svg/ethereum.svg" alt="">
                                    </div>
                                </div>
                                <div class="single-transaction">
                                    <div class="flag">
                                        <img src="frontend/img/flag/flag-4.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                                    ...
                                    <div class="coin">
                                        <img src="frontend/img/svg/litecoin.svg" alt="">
                                    </div>
                                </div>
                                <div class="single-transaction">
                                    <div class="flag">
                                ...
                                <div class="single-transaction">
                                    <div class="flag">
                                        <img src="frontend/img/flag/flag-3.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                                        <span class="name">Aidan Ward</span>
                                        <span class="tr-type">Trxn: Deposit</span>
                ...
                <div class="row justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/withdraw.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/referral.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/affiliate-marketing.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                    ...
                    <div class="col-xl-4 col-lg-2 d-xl-flex d-lg-none d-block align-items-end">
                        <div class="part-img">
                            ...
                            <img src="frontend/img/choosing-reason.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-sm-10 col-md-12">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/bird.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/shield.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-4">
                                    <div class="single-reason">
                                        <div class="icon-box">
                                            <div class="part-icon">
                                                <img src="frontend/img/svg/customer-service.svg" alt="">
                                            </div>
                                        </div>
                                        <div class="part-text">
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="testi-text-slider">
                                <div class="single-testimonial">
                                    <span class="quot-icon">
                                        <img src="frontend/img/icon/quot.png" alt="">
                                    </span>
                            ...
                            <div class="testi-user-slider">
                                <div class="single-user">
                                    <img src="frontend/img/testimonial.png" alt="">
                                </div>
                                <div class="single-user">
                                    <img src="frontend/img/testimonia-2.png" alt="">
                                </div>
                                <div class="single-user">
                                    <img src="frontend/img/testimonia-3.png" alt="">
                                </div>
                                <div class="single-user">
                                    <img src="frontend/img/testimonial.png" alt="">
                                </div>
                ...
                <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-10 col-md-6">
                        <div class="part-crypto">
                            ...
                            <div class="part-img">
                                <img src="frontend/img/crypto-currency.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="all-payment">
                            ...
                            <div class="gateway-slider">
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-1.jpg" alt="">
                                </div>
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-2.jpg" alt="">
                                </div>
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-4.jpg" alt="">
                                </div>
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-3.jpg" alt="">
                                </div>
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-5.jpg" alt="">
                                </div>
                                <div class="single-payment-way">
                                    <img src="frontend/img/brand/brand-1.jpg" alt="">
                                </div>
