...
<div class="d-xl-none d-lg-none d-block">
    <div class="mobile-navigation-bar">
        <ul>
            <li>
                <a href="#0">
                    <img src="frontend/img/svg/profile.svg" alt="">
                </a>
            </li>
            <li>
                <a href="#0">
                    <img src="frontend/img/svg/money-transfering.svg" alt="">
                </a>
            </li>
            <li>
                <a href="#0">
                    <img src="frontend/img/svg/calculator.svg" alt="">
                </a>
            </li>
            <li>
                <a href="#header">
                    <img src="frontend/img/svg/arrow.svg" alt="">
                </a>
            </li>
        </ul>
    </div>
...
<!-- modal video js -->
<script src="frontend/js/jquery-modal-video.min.js"></script>
<!-- slick js -->
<script src="frontend/js/slick.min.js"></script>
<!-- toastr js -->
<script src="frontend/js/toastr.min.js"></script>
<!-- investment profit calculator-->
<script src="frontend/js/investment-profit-calculator.js"></script>
<!-- main -->
